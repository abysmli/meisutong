...
strFrame+='BORDER-BOTTOM: #ACEEFF 1px solid;BACKGROUND-COLOR: #fff8ec;font-family:宋体;}';
...
strFrame+='             <input Author=meizz type=button class=button value=空 onclick="parent.meizzClear()" ';
strFrame+='             onfocus="this.blur()" title="清空" style="font-size: 12px; height: 20px; cursor:hand"></td><td ';
...
function meizzClear()  //Clear Button
  {
    outObject.value="";
    closeLayer();
  }
